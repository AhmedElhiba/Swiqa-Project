    ...
    <>
      <Form {...form}>
        <form
          ...
          className="space-y-8 p-6 bg-gray-100 rounded-lg shadow-md max-w-lg mx-auto"
        >
          <FormField
                    ...
                    <div className="absolute left-3 top-2.5 text-gray-400">
                      ...
                      >
                        <path
                          ...
                          d="M16 12H4m8 8h4m0-4h-4m0-8h4m4 0a9 9 0 11-9 9 9 9 0 019-9z"
                        />
                      </svg>
                    </div>
                  </div>
                    ...
                    <div className="absolute left-3 top-2.5 text-gray-400">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round" // ✅ Corrected
                          strokeWidth="2" // ✅ Corrected
                          d="M15 12l-3 3-3-3M12 9V4m0 0a9 9 0 1118 0h-2a7 7 0 10-14 0h-2a9 9 0 1118 0z"
                        />
                      </svg>
                    </div>
                  </div>
