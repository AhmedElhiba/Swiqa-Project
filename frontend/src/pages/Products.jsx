...
import { MdOutlineRemoveRedEye, MdAddShoppingCart, MdRemoveShoppingCart } from 'react-icons/md';
                ...
                return (
                  ...
                  >
                    ...
                    {/* <div id="icons" className="flex justify-center items-center gap-3 absolute top-[10px] left-0 right-0 mx-auto">
                      ...
                      <div 
                        className={`${inCart ? 'bg-red-500' : 'bg-themegreen'} hover:bg-themesage hover:text-black rounded-full p-2 text-white`}
                        onClick={() => toggleProductInCart(item)}
                      >
                        {inCart ? <MdRemoveShoppingCart /> : <MdAddShoppingCart />}
                      </div>
                    </div> */}
