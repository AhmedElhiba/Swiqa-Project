...
import underunder from '../images/underunder1.png'


export default function Home() {
  return <>
  {/* <img src={underunder} alt="" className=''/> */}
  <div className=" items-center justify-center text-center p-4">
      ...
      {/* Content */}
      <div className="relative z-10 bg-[#efe3c2] p-6 rounded-lg shadow-lg text-[#3e7b27] max-w-md w-full text-center">
        <h1 className="text-4xl font-bold text-[#e6d05c] mb-4">Under Construction</h1>
        <p className="text-lg text-[#a4a95b] mb-4">We’re working hard to bring you something amazing!</p>
        <p className="text-md text-[#d6c086] mb-6">Stay tuned and check back soon.</p>
        {/* Spinner */}
        <div className="w-12 h-12 border-4 border-t-4 border-[#a4a95b] rounded-full animate-spin mx-auto"></div>
      </div>
    </div>
  </>}
